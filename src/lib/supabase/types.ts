...
export type Database = {
  public: {
    ...
    Tables: {
      ...
      product_media: Table<{ id: string; product_id: string; storage_path: string | null; public_url: string | null; alt_text: string | null; sort_order: number; created_at: string; media_type: "image" | "youtube"; external_url: string | null; provider: string | null; video_id: string | null; thumbnail_url: string | null; title: string | null }>;

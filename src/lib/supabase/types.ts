...
export type Database = {
  public: {
    ...
    Tables: {
      ...
      products: Table<{ id: string; seller_id: string; slug: string; name: string; game: string; category: string; status: ProductStatus; website_url: string | null; summary: string | null; features: string[]; features_grouped: Json; price_points: string[]; trust_score: number | null; created_at: string; updated_at: string }>;
